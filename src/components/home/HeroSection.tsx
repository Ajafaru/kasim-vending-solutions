...
export const HeroSection = () => {
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="container-section relative z-10 pt-12 pb-20">
        <div className="flex flex-col items-center text-center">
          ...
          <img
            src={logo}
            alt="Kasim Vending"
            className="w-full max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-3xl drop-shadow-[0_18px_30px_rgba(0,0,0,0.35)] animate-slide-up"
          />
